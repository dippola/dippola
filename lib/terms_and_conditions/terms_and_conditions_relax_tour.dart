...
class TermsAndConditionsRelaxTour extends StatelessWidget {
  const TermsAndConditionsRelaxTour({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [SelectableText(TermsAndConditionsRelaxTourText.text, style: TextStyle(height: 1.5),)],
              ),
            ),
          ],
        ),
